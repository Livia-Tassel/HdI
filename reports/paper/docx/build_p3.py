...
TABLE_MARKERS = {
    "[[TABLE_DATA_SOURCE]]": {
        "rows": [
            ...
            ["疾病死亡", "IHME官方GBDResultsTool\nhttps://vizhub.healthdata.org/gbd-results/", "死因、死亡人数、上下界", "构造疾病负担与传染病占比；2000—2023年"],
            ["风险因素", "IHME官方GBDResultsTool\nhttps://vizhub.healthdata.org/gbd-results/", "风险因素、归因死亡", "辅助解释健康风险；2000—2023年"],
            ["全球卫生人口", "世界银行官方数据库\nhttps://databank.worldbank.org/source/health-nutrition-and-population-statistics\nhttps://databank.worldbank.org/source/world-development-indicators", "Phys、Beds、LE、IMR、U5MR、HExpPC", "构造国家投入、产出和需求指数"],
            ["国家分组", "世界银行官方数据库\nhttps://databank.worldbank.org/source/world-development-indicators", "IncomeGroup、地区信息", "用于收入组和WHO地区分组"],
            ["中国省级", "国家统计局官方数据\nhttps://www.stats.gov.cn/sj/ndsj/", "卫生人员、机构、寿命、出生率", "31省×20年，用于省级再分配"],
        ],
    ...
    "[[TABLE_INDICATORS]]": {
        "rows": [
            ["指标名称", "代号", "官方来源及地址", "说明"],
            ["医生密度", "Phys", "世界银行官方数据库\nhttps://databank.worldbank.org/source/health-nutrition-and-population-statistics\nhttps://databank.worldbank.org/source/world-development-indicators", "每千人医生数，03优先，缺失回退04"],
            ["床位密度", "Beds", "世界银行官方数据库\nhttps://databank.worldbank.org/source/health-nutrition-and-population-statistics\nhttps://databank.worldbank.org/source/world-development-indicators", "每千人床位数，03优先，缺失回退04"],
            ["卫生支出占GDP", "HExp", "世界银行官方数据库\nhttps://databank.worldbank.org/source/world-development-indicators", "世界银行指标，单位为百分比"],
            ["人均卫生支出", "HExpPC", "世界银行官方数据库\nhttps://databank.worldbank.org/source/world-development-indicators", "当前美元口径"],
            ["传染性疾病占比", "CommSh", "IHME官方GBDResultsTool\nhttps://vizhub.healthdata.org/gbd-results/", "传染病死亡占全因死亡比例"],
            ["婴儿死亡率", "IMR", "世界银行官方数据库\nhttps://databank.worldbank.org/source/health-nutrition-and-population-statistics\nhttps://databank.worldbank.org/source/world-development-indicators", "每千活产儿死亡数"],
            ["5岁以下死亡率", "U5MR", "世界银行官方数据库\nhttps://databank.worldbank.org/source/health-nutrition-and-population-statistics\nhttps://databank.worldbank.org/source/world-development-indicators", "每千活产儿死亡数"],
            ["预期寿命", "LE", "世界银行官方数据库\nhttps://databank.worldbank.org/source/health-nutrition-and-population-statistics\nhttps://databank.worldbank.org/source/world-development-indicators", "出生时预期寿命，单位为岁"],
        ],
