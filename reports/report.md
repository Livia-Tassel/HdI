...
其中 $B = \alpha \cdot \sum_i x_i^{\text{current}}$ 为预算总量，$x_i^{\min} = 0.5 \cdot x_i^{\text{current}}$，$x_i^{\max} = 2.0 \cdot x_i^{\text{current}}$。
...
利用赛题第五类数据分析31个省级行政区2005–2024年卫生人员和机构趋势。
